...
export default class App extends React.Component<Props, State> {
  ...
  private formDataUpload = async (params:any) => {  
  ...
  private onGenerateSigns = async () => {
    ...
    const apiEndpoint = "http://192.168.1.8:105/speech-to-text";
    ...
    fetch(apiEndpoint, {
      ...
      .then((data) => {
        ...
        if (data && data.recognized_images) {
          // Update the recognizedImages array with the transcription
          this.setState((prevState) => ({
            recognizedImages: [...prevState.recognizedImages, ...data.recognized_images],
          }));
        }
        this.setState({
          isLoading: false,
